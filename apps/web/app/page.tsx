    ...
    <div className="flex h-dvh bg-[#eff6ff] font-sans">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-y-auto">
        <div className="px-8 py-8">
          <h1 className="mb-1 text-[22px] font-bold tracking-tight text-[#1a2a33]">Runs</h1>
          <p className="mb-8 text-[13px] text-[#4a7ab5]">Your recent test runs</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="text-[14px] font-semibold text-[#1a2a33] transition-colors group-hover:text-[#1d6ef5]">
                      {run.name}
                    </div>
