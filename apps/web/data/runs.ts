...
const securitySteps: RunStep[] = [
  {
    id: "sec-1", index: 1, action: "navigate", nodeId: "landing",
  ...
  {
    id: "sec-2", index: 2, action: "audit", nodeId: "landing",
  ...
  {
    id: "sec-3", index: 3, action: "audit", nodeId: "landing",
  ...
  {
    id: "sec-4", index: 4, action: "screenshot", nodeId: "landing",
    target: "document",
  ...
  {
    id: "sec-5", index: 5, action: "navigate", nodeId: "login",
  ...
  {
    id: "sec-6", index: 6, action: "audit", nodeId: "login",
  ...
  {
    id: "sec-7", index: 7, action: "audit", nodeId: "login",
  ...
  {
    id: "sec-8", index: 8, action: "screenshot", nodeId: "login",
    target: "document",
  ...
  {
    id: "sec-9", index: 9, action: "navigate", nodeId: "dashboard",
  ...
  {
    id: "sec-10", index: 10, action: "audit", nodeId: "dashboard",
  ...
  {
    id: "sec-11", index: 11, action: "screenshot", nodeId: "dashboard",
    target: "document",
...
const buttonSteps: RunStep[] = [
  {
    id: "btn-1", index: 1, action: "navigate", nodeId: "landing",
    target: "https://timeedit.com",
  ...
  {
    id: "btn-2", index: 2, action: "audit", nodeId: "landing",
    target: "document",
  ...
  {
    id: "btn-3", index: 3, action: "click", nodeId: "landing",
  ...
  {
    id: "btn-4", index: 4, action: "audit", nodeId: "landing",
    target: "button.cta-primary",
  ...
  {
    id: "btn-5", index: 5, action: "screenshot", nodeId: "landing",
    target: "document",
  ...
  {
    id: "btn-6", index: 6, action: "navigate", nodeId: "login",
    target: "https://timeedit.com/login",
    description: "Navigated to login page.",
  ...
  {
    id: "btn-7", index: 7, action: "fill", nodeId: "login",
  ...
  {
    id: "btn-8", index: 8, action: "fill", nodeId: "login",
  ...
  {
    id: "btn-9", index: 9, action: "click", nodeId: "login",
  ...
  {
    id: "btn-10", index: 10, action: "audit", nodeId: "login",
    target: "button[type='submit']",
  ...
  {
    id: "btn-11", index: 11, action: "screenshot", nodeId: "login",
    target: "document",
  ...
  {
    id: "btn-12", index: 12, action: "navigate", nodeId: "dashboard",
    target: "https://timeedit.com/dashboard",
  ...
  {
    id: "btn-13", index: 13, action: "audit", nodeId: "dashboard",
  ...
  {
    id: "btn-14", index: 14, action: "audit", nodeId: "dashboard",
  ...
  {
    id: "btn-15", index: 15, action: "screenshot", nodeId: "dashboard",
    target: "document",
...
const uxSteps: RunStep[] = [
  {
    id: "ux-1", index: 1, action: "navigate", nodeId: "landing",
    target: "https://timeedit.com",
    description: "Navigated to landing page in a clean context.",
  ...
  {
    id: "ux-2", index: 2, action: "scroll", nodeId: "landing",
    target: "window",
  ...
  {
    id: "ux-3", index: 3, action: "audit", nodeId: "landing",
    target: "document",
  ...
  {
    id: "ux-4", index: 4, action: "click", nodeId: "landing",
    target: "button.cta-primary",
  ...
  {
    id: "ux-5", index: 5, action: "wait", nodeId: "login",
    target: "form#login-form",
  ...
  {
    id: "ux-6", index: 6, action: "audit", nodeId: "login",
    target: "form#login-form",
  ...
  {
    id: "ux-7", index: 7, action: "fill", nodeId: "login",
    target: "input[type='email']",
  ...
  {
    id: "ux-8", index: 8, action: "fill", nodeId: "login",
    target: "input[type='password']",
  ...
  {
    id: "ux-9", index: 9, action: "click", nodeId: "login",
    target: "button[type='submit']",
  ...
  {
    id: "ux-10", index: 10, action: "wait", nodeId: "dashboard",
  ...
  {
    id: "ux-11", index: 11, action: "resize", nodeId: "dashboard",
    target: "window",
  ...
  {
    id: "ux-12", index: 12, action: "audit", nodeId: "dashboard",
  ...
  {
    id: "ux-13", index: 13, action: "screenshot", nodeId: "dashboard",
    target: "document",
